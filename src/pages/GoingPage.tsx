...
const DEMO_GOINGS: Going[] = [
  {
    ...
    user: { id: "u2", microsoft_id: "x", name: "Priya Sharma", email: "priya@isb.edu", section: "A", cohort_year: 2026, vibe_tags: ["Party Animal"], budget_min: 1000, budget_max: 5000, location_sharing: false, created_at: new Date().toISOString() },
  ...
  },
  {
    ...
    user: { id: "u3", microsoft_id: "y", name: "Rahul Menon", email: "rahul@isb.edu", section: "C", cohort_year: 2026, vibe_tags: ["Explorer"], budget_min: 500, budget_max: 3000, location_sharing: false, created_at: new Date().toISOString() },
